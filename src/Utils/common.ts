...
export const businessVertical = [
    { label: "Aerospace (aircraft manufacturing)", value: "Aerospace (aircraft manufacturing)" },
    ...
    { label: "Energy (production, distribution)", value: "Energy (production, distribution)" },
...
export const steps = ['BRAND REGISTRATION', 'ADDRESS & CONTACT', 'CONFIRM DETAILS', 'PREVIEW'];
...
export const formatFieldName = (fieldName: string) => {
    ...
    return formattedFieldName.charAt(0).toUpperCase() + formattedFieldName.slice(1);
}